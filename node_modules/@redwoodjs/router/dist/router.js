...
const InternalRoute = _ref => {
  ...
  const Page = ((_activePageContext$lo2 = activePageContext.loadingState[path]) === null || _activePageContext$lo2 === void 0 ? void 0 : _activePageContext$lo2.page) || (() => null); // There are two special props in React: `ref` and `key`. (See https://reactjs.org/warnings/special-props.html.)
  ...
  delete allParams['key']; // Level 3/3 (InternalRoute)
