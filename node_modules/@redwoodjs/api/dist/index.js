...
_Object$defineProperty(exports, "hashPassword", {
  enumerable: true,
  get: function () {
    return _shared.hashPassword;
  }
});
...
_forEachInstanceProperty(_context7 = _Object$keys(_transforms)).call(_context7, function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
...
_forEachInstanceProperty(_context8 = _Object$keys(_cors)).call(_context8, function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
